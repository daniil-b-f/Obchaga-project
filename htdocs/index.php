...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['save'])) {
    ...
    if ($passport_photo && $form_086u_photo && $mor_photo && $hiv_aids_photo) {
        $stmt = $conn->prepare("INSERT INTO students (fio, faculty, group_number, education_form, education_type, phone, email, folder_name, passport_photo, form_086u_photo, mor_photo, hiv_aids_photo) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("ssssssssssss", $fio, $faculty, $group_number, $education_form, $education_type, $phone, $email, $user_dir, $passport_photo, $form_086u_photo, $mor_photo, $hiv_aids_photo);
